...
kwh_rate        = 0.24  # cost per kilowatt hour per currency_type to calculate cost to run job
kw_elements     = 5.520 # if the kiln elements are on, the wattage in kilowatts
